...
class Block(nn.Module):
    ...
    def attention_pooling(self, attention_list, layer_past=None):
        ...
        elif self.attention_fusion_type == 'dys':
        ...
        elif self.attention_fusion_type == 'dyd':
    ...
    def sampling_inference(self, input_ids, token_type_ids):
        with torch.no_grad():
            ...
            for i in range(self.max_seq_len):
                ...
                topk_indices = torch.argsort(probs, dim=1, descending=True)[:, :100]
